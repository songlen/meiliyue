...
//获取省
function getProObj(code){
    let arr=areaColdeArr.filter(function(proObj){
        return proObj.code==code
    })
    return arr[0]
}
//获取市
function getCityObj(code){
    let obj={}
    areaColdeArr.forEach(function(proObj){
        if(proObj.sub){
            proObj.sub.forEach(function(cityObj){
                if(cityObj.code==code){
                    obj=cityObj
                }
            })
        }
